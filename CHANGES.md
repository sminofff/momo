...
- [ADD] `--force-nv12` オプションを追加し、ビデオキャプチャで NV12 フォーマットを強制できるようにする
- [ADD] `--force-yuy2` オプションを追加し、ビデオキャプチャで YUY2 フォーマットを強制できるようにする
- [UPDATE] V4L2 ビデオキャプチャで NV12 フォーマットをサポート
